...
def search_entries(categories: List[str], date_0: date, date_f: date) -> List[feedparser.FeedParserDict]:
    ...
    # Dates
    date_0 = f'{date_0.year:04d}{date_0.month:02d}{date_0.day:02d}2000'  # GMT?
    date_f = f'{date_f.year:04d}{date_f.month:02d}{date_f.day:02d}2000'
    ...
    while True:
        ...
        entries = feedparser.parse(base_url + query + n_entries).entries
